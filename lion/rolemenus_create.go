...
func (_c *RoleMenusCreate) SetPermissionScope(v int) *RoleMenusCreate {
	_c.mutation.SetPermissionScope(v)
	return _c
}
...
func (_c *RoleMenusCreate) defaults() {
	...
	if _, ok := _c.mutation.CreatedBy(); !ok {
		v := rolemenus.DefaultCreatedBy
		_c.mutation.SetCreatedBy(v)
	}
	if _, ok := _c.mutation.UpdatedBy(); !ok {
		v := rolemenus.DefaultUpdatedBy
		_c.mutation.SetUpdatedBy(v)
	}
	if _, ok := _c.mutation.PermissionScope(); !ok {
		v := rolemenus.DefaultPermissionScope
		_c.mutation.SetPermissionScope(v)
	}
	if _, ok := _c.mutation.Description(); !ok {
		v := rolemenus.DefaultDescription
		_c.mutation.SetDescription(v)
	}
	if _, ok := _c.mutation.IsRecursive(); !ok {
		v := rolemenus.DefaultIsRecursive
		_c.mutation.SetIsRecursive(v)
	}
}
...
func (_c *RoleMenusCreate) check() error {
	...
	if _, ok := _c.mutation.PermissionScope(); !ok {
		return &ValidationError{Name: "permission_scope", err: errors.New(`lion: missing required field "RoleMenus.permission_scope"`)}
	}
	if _, ok := _c.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`lion: missing required field "RoleMenus.description"`)}
	}
	if _, ok := _c.mutation.IsRecursive(); !ok {
		return &ValidationError{Name: "is_recursive", err: errors.New(`lion: missing required field "RoleMenus.is_recursive"`)}
	}
...
func (_c *RoleMenusCreate) createSpec() (*RoleMenus, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.PermissionScope(); ok {
		_spec.SetField(rolemenus.FieldPermissionScope, field.TypeInt, value)
		_node.PermissionScope = value
	}
