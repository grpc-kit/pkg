...
const (
	// Label holds the string label denoting the roleusermapping type in the database.
	Label = "role_user_mapping"
	...
	// Table holds the table name of the roleusermapping in the database.
	Table = "lion_role_user_mapping"
	// LionRolesTable is the table that holds the lion_roles relation/edge.
	LionRolesTable = "lion_role_user_mapping"
...
// Columns holds all SQL columns for roleusermapping fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the RoleUserMapping queries.
