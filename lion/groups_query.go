...
type GroupsQuery struct {
	...
	withLionGroups *RoleGroupMappingQuery
...
func (_q *GroupsQuery) QueryLionGroups() *RoleGroupMappingQuery {
...
func (_q *GroupsQuery) All(ctx context.Context) ([]*Groups, error) {
	...
	return withInterceptors[[]*Groups](ctx, _q, qr, _q.inters)
}
...
func (_q *GroupsQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = _q.Select(groups.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *GroupsQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*GroupsQuery](), _q.inters)
}
...
func (_q *GroupsQuery) WithLionGroups(opts ...func(*RoleGroupMappingQuery)) *GroupsQuery {
	query := (&RoleGroupMappingClient{config: _q.config}).Query()
...
func (_q *GroupsQuery) GroupBy(field string, fields ...string) *GroupsGroupBy {
	...
	grbuild := &GroupsGroupBy{build: _q}
...
func (_q *GroupsQuery) Select(fields ...string) *GroupsSelect {
	...
	sbuild := &GroupsSelect{GroupsQuery: _q}
...
func (_q *GroupsQuery) prepareQuery(ctx context.Context) error {
...
func (_q *GroupsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Groups, error) {
	...
	if query := _q.withLionGroups; query != nil {
		if err := _q.loadLionGroups(ctx, query, nodes,
			func(n *Groups) { n.Edges.LionGroups = []*RoleGroupMapping{} },
			func(n *Groups, e *RoleGroupMapping) { n.Edges.LionGroups = append(n.Edges.LionGroups, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *GroupsQuery) loadLionGroups(ctx context.Context, query *RoleGroupMappingQuery, nodes []*Groups, init func(*Groups), assign func(*Groups, *RoleGroupMapping)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(rolegroupmapping.FieldGroupID)
	}
...
func (_q *GroupsQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *GroupsQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *GroupsQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *GroupsGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*GroupsQuery, *GroupsGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *GroupsGroupBy) sqlScan(ctx context.Context, root *GroupsQuery, v any) error {
...
func (_s *GroupsSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*GroupsQuery, *GroupsSelect](ctx, _s.GroupsQuery, _s, _s.inters, v)
}

func (_s *GroupsSelect) sqlScan(ctx context.Context, root *GroupsQuery, v any) error {
