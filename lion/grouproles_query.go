...
func (_q *GroupRolesQuery) Where(ps ...predicate.GroupRoles) *GroupRolesQuery {
...
func (_q *GroupRolesQuery) Order(o ...grouproles.OrderOption) *GroupRolesQuery {
...
func (_q *GroupRolesQuery) QueryLionGroups() *GroupsQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(grouproles.Table, grouproles.FieldID, selector),
...
// First returns the first GroupRoles entity from the query.
// Returns a *NotFoundError when no GroupRoles was found.
func (_q *GroupRolesQuery) First(ctx context.Context) (*GroupRoles, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{grouproles.Label}
	}
	return nodes[0], nil
}
...
// FirstID returns the first GroupRoles ID from the query.
// Returns a *NotFoundError when no GroupRoles ID was found.
...
// Only returns a single GroupRoles entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one GroupRoles entity is found.
// Returns a *NotFoundError when no GroupRoles entities are found.
func (_q *GroupRolesQuery) Only(ctx context.Context) (*GroupRoles, error) {
	...
	case 0:
		return nil, &NotFoundError{grouproles.Label}
	default:
		return nil, &NotSingularError{grouproles.Label}
	}
}
...
// OnlyID is like Only, but returns the only GroupRoles ID in the query.
// Returns a *NotSingularError when more than one GroupRoles ID is found.
...
func (_q *GroupRolesQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{grouproles.Label}
	default:
		err = &NotSingularError{grouproles.Label}
	}
	return
}
...
func (_q *GroupRolesQuery) All(ctx context.Context) ([]*GroupRoles, error) {
	...
	qr := querierAll[[]*GroupRoles, *GroupRolesQuery]()
	return withInterceptors[[]*GroupRoles](ctx, _q, qr, _q.inters)
}
...
func (_q *GroupRolesQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = _q.Select(grouproles.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *GroupRolesQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*GroupRolesQuery](), _q.inters)
}
...
// Clone returns a duplicate of the GroupRolesQuery builder, including all associated steps. It can be
...
func (_q *GroupRolesQuery) Clone() *GroupRolesQuery {
	...
	return &GroupRolesQuery{
		config:         _q.config,
		ctx:            _q.ctx.Clone(),
		order:          append([]grouproles.OrderOption{}, _q.order...),
		inters:         append([]Interceptor{}, _q.inters...),
		predicates:     append([]predicate.GroupRoles{}, _q.predicates...),
...
func (_q *GroupRolesQuery) GroupBy(field string, fields ...string) *GroupRolesGroupBy {
	...
	grbuild := &GroupRolesGroupBy{build: _q}
	grbuild.flds = &_q.ctx.Fields
	grbuild.label = grouproles.Label
...
func (_q *GroupRolesQuery) Select(fields ...string) *GroupRolesSelect {
	...
	sbuild := &GroupRolesSelect{GroupRolesQuery: _q}
	sbuild.label = grouproles.Label
...
func (_q *GroupRolesQuery) prepareQuery(ctx context.Context) error {
...
func (_q *GroupRolesQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*GroupRoles, error) {
	var (
		nodes       = []*GroupRoles{}
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
	...
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*GroupRoles).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &GroupRoles{config: _q.config}
	...
	if query := _q.withLionGroups; query != nil {
		if err := _q.loadLionGroups(ctx, query, nodes, nil,
			func(n *GroupRoles, e *Groups) { n.Edges.LionGroups = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLionRoles; query != nil {
		if err := _q.loadLionRoles(ctx, query, nodes, nil,
			func(n *GroupRoles, e *Roles) { n.Edges.LionRoles = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *GroupRolesQuery) loadLionGroups(ctx context.Context, query *GroupsQuery, nodes []*GroupRoles, init func(*GroupRoles), assign func(*GroupRoles, *Groups)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*GroupRoles)
	for i := range nodes {
		fk := nodes[i].GroupID
...
func (_q *GroupRolesQuery) loadLionRoles(ctx context.Context, query *RolesQuery, nodes []*GroupRoles, init func(*GroupRoles), assign func(*GroupRoles, *Roles)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*GroupRoles)
	for i := range nodes {
		fk := nodes[i].RoleID
...
func (_q *GroupRolesQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *GroupRolesQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(grouproles.Table, grouproles.Columns, sqlgraph.NewFieldSpec(grouproles.FieldID, field.TypeInt))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != grouproles.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if _q.withLionGroups != nil {
			_spec.Node.AddColumnOnce(grouproles.FieldGroupID)
		}
		if _q.withLionRoles != nil {
			_spec.Node.AddColumnOnce(grouproles.FieldRoleID)
		}
	}
...
func (_q *GroupRolesQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(_q.driver.Dialect())
	t1 := builder.Table(grouproles.Table)
...
func (_g *GroupRolesGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*GroupRolesQuery, *GroupRolesGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *GroupRolesGroupBy) sqlScan(ctx context.Context, root *GroupRolesQuery, v any) error {
...
func (_s *GroupRolesSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*GroupRolesQuery, *GroupRolesSelect](ctx, _s.GroupRolesQuery, _s, _s.inters, v)
}

func (_s *GroupRolesSelect) sqlScan(ctx context.Context, root *GroupRolesQuery, v any) error {
