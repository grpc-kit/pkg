...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			permissionsbindings.Table: permissionsbindings.ValidColumn,
	...
	return func(s *sql.Selector) {
		for _, f := range fields {
			if err := checkColumn(s.TableName(), f); err != nil {
				s.AddError(&ValidationError{Name: f, err: fmt.Errorf("lion: %w", err)})
			}
...
func Max(field string) AggregateFunc {
	return func(s *sql.Selector) string {
		if err := checkColumn(s.TableName(), field); err != nil {
			s.AddError(&ValidationError{Name: field, err: fmt.Errorf("lion: %w", err)})
			return ""
		}
...
func (e *NotSingularError) Error() string {
	return "lion: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "lion: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "lion: constraint failed: " + e.msg
}
...
func (s *selector) Strings(ctx context.Context) ([]string, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("lion: Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) String(ctx context.Context) (_ string, err error) {
	...
	default:
		err = fmt.Errorf("lion: Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Ints(ctx context.Context) ([]int, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("lion: Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("lion: Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Float64s(ctx context.Context) ([]float64, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("lion: Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("lion: Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (s *selector) Bools(ctx context.Context) ([]bool, error) {
	if len(*s.flds) > 1 {
		return nil, errors.New("lion: Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := s.scan(ctx, &v); err != nil {
		return nil, err
...
func (s *selector) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{s.label}
	default:
		err = fmt.Errorf("lion: Bools returned %d results when one was expected", len(v))
	}
	return
}
