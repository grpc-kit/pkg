...
const (
	// Label holds the string label denoting the roledatascopes type in the database.
	Label = "role_data_scopes"
	...
	// FieldScopeInherit holds the string denoting the scope_inherit field in the database.
	FieldScopeInherit = "scope_inherit"
	// EdgeLionRoles holds the string denoting the lion_roles edge name in mutations.
	EdgeLionRoles = "lion_roles"
	// Table holds the table name of the roledatascopes in the database.
	Table = "lion_role_data_scopes"
	// LionRolesTable is the table that holds the lion_roles relation/edge.
	LionRolesTable = "lion_role_data_scopes"
...
// Columns holds all SQL columns for roledatascopes fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "lion_role_data_scopes"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"departments_lion_role_data_scopes",
}
...
var (
	...
	// DefaultScopeInherit holds the default value on creation for the "scope_inherit" field.
	DefaultScopeInherit bool
)

// OrderOption defines the ordering options for the RoleDataScopes queries.
...
// ByScopeInherit orders the results by the scope_inherit field.
func ByScopeInherit(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldScopeInherit, opts...).ToFunc()
}
