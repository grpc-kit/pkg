...
func (_q *CredentialsQuery) Where(ps ...predicate.Credentials) *CredentialsQuery {
...
func (_q *CredentialsQuery) Order(o ...credentials.OrderOption) *CredentialsQuery {
...
func (_q *CredentialsQuery) All(ctx context.Context) ([]*Credentials, error) {
	...
	return withInterceptors[[]*Credentials](ctx, _q, qr, _q.inters)
}
...
func (_q *CredentialsQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = _q.Select(credentials.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *CredentialsQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*CredentialsQuery](), _q.inters)
}
...
func (_q *CredentialsQuery) Clone() *CredentialsQuery {
	...
	return &CredentialsQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]credentials.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.Credentials{}, _q.predicates...),
...
func (_q *CredentialsQuery) GroupBy(field string, fields ...string) *CredentialsGroupBy {
	...
	grbuild := &CredentialsGroupBy{build: _q}
...
func (_q *CredentialsQuery) Select(fields ...string) *CredentialsSelect {
	...
	sbuild := &CredentialsSelect{CredentialsQuery: _q}
...
func (_q *CredentialsQuery) prepareQuery(ctx context.Context) error {
...
func (_q *CredentialsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Credentials, error) {
	var (
		nodes = []*Credentials{}
		_spec = _q.querySpec()
	)
	...
	_spec.Assign = func(columns []string, values []any) error {
		node := &Credentials{config: _q.config}
...
func (_q *CredentialsQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *CredentialsQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *CredentialsQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *CredentialsGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*CredentialsQuery, *CredentialsGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *CredentialsGroupBy) sqlScan(ctx context.Context, root *CredentialsQuery, v any) error {
...
func (_s *CredentialsSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*CredentialsQuery, *CredentialsSelect](ctx, _s.CredentialsQuery, _s, _s.inters, v)
}

func (_s *CredentialsSelect) sqlScan(ctx context.Context, root *CredentialsQuery, v any) error {
