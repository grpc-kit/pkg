...
const (
	// Label holds the string label denoting the rolegroupmapping type in the database.
	Label = "role_group_mapping"
	...
	// Table holds the table name of the rolegroupmapping in the database.
	Table = "lion_role_group_mapping"
	// LionRolesTable is the table that holds the lion_roles relation/edge.
	LionRolesTable = "lion_role_group_mapping"
...
// Columns holds all SQL columns for rolegroupmapping fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the RoleGroupMapping queries.
