...
func (_d *RolePoliciesDelete) Where(ps ...predicate.RolePolicies) *RolePoliciesDelete {
...
func (_d *RolePoliciesDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(rolepolicies.Table, sqlgraph.NewFieldSpec(rolepolicies.FieldID, field.TypeInt))
...
type RolePoliciesDeleteOne struct {
	_d *RolePoliciesDelete
}

// Where appends a list predicates to the RolePoliciesDelete builder.
func (_d *RolePoliciesDeleteOne) Where(ps ...predicate.RolePolicies) *RolePoliciesDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *RolePoliciesDeleteOne) Exec(ctx context.Context) error {
	n, err := _d._d.Exec(ctx)
	switch {
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{rolepolicies.Label}
	default:
		return nil
	}
}
