...
// RoleGroups 角色与用户组的关系
type RoleGroups struct {
	ent.Schema
}

// Fields of the table.
func (RoleGroups) Fields() []ent.Field {
	return []ent.Field{
		field.Int("role_id").
			Positive().
			// Immutable().
...
// Edges of the table.
func (RoleGroups) Edges() []ent.Edge {
	return []ent.Edge{
...
// Mixin of the table.
func (RoleGroups) Mixin() []ent.Mixin {
	return []ent.Mixin{
...
func (RoleGroups) Indexes() []ent.Index {
	return []ent.Index{
...
// Annotations 自定义表名
func (RoleGroups) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "lion_role_groups"},
	}
}
