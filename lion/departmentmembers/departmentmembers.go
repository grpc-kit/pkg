...
const (
	// Label holds the string label denoting the departmentmembers type in the database.
	...
	// Table holds the table name of the departmentmembers in the database.
	Table = "lion_department_members"
	// LionDepartmentsTable is the table that holds the lion_departments relation/edge.
	LionDepartmentsTable = "lion_department_members"
	...
	LionUsersTable = "lion_department_members"
...
// Columns holds all SQL columns for departmentmembers fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the DepartmentMembers queries.
