...
var (
	...
	LionCredentialsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "credentials_credential_type",
				Unique:  false,
				Columns: []*schema.Column{LionCredentialsColumns[9]},
			},
			{
				Name:    "credentials_credential_status",
				Unique:  false,
				Columns: []*schema.Column{LionCredentialsColumns[13]},
			},
			{
				Name:    "credentials_credential_usage",
				Unique:  false,
				Columns: []*schema.Column{LionCredentialsColumns[11]},
			},
			{
				Name:    "credentials_credential_source",
				Unique:  false,
				Columns: []*schema.Column{LionCredentialsColumns[14]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{LionCredentialsColumns[4]},
			},
		},
	}
