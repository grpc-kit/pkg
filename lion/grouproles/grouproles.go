...
const (
	// Label holds the string label denoting the grouproles type in the database.
	Label = "group_roles"
...
// Columns holds all SQL columns for grouproles fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the GroupRoles queries.
