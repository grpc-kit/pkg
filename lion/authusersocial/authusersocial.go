...
const (
	// Label holds the string label denoting the authusersocial type in the database.
	Label = "auth_user_social"
	...
	// Table holds the table name of the authusersocial in the database.
	Table = "lion_auth_user_social"
)

// Columns holds all SQL columns for authusersocial fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the AuthUserSocial queries.
