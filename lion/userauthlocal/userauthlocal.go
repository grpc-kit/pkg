...
const (
	// Label holds the string label denoting the userauthlocal type in the database.
	Label = "user_auth_local"
	...
	// Table holds the table name of the userauthlocal in the database.
	Table = "lion_user_auth_local"
)

// Columns holds all SQL columns for userauthlocal fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the UserAuthLocal queries.
