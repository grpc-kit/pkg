...
func (_q *UserRolesQuery) Where(ps ...predicate.UserRoles) *UserRolesQuery {
...
func (_q *UserRolesQuery) Order(o ...userroles.OrderOption) *UserRolesQuery {
...
func (_q *UserRolesQuery) All(ctx context.Context) ([]*UserRoles, error) {
	...
	return withInterceptors[[]*UserRoles](ctx, _q, qr, _q.inters)
}
...
func (_q *UserRolesQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = _q.Select(userroles.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *UserRolesQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*UserRolesQuery](), _q.inters)
}
...
func (_q *UserRolesQuery) Clone() *UserRolesQuery {
	...
	return &UserRolesQuery{
		config:        _q.config,
		ctx:           _q.ctx.Clone(),
		order:         append([]userroles.OrderOption{}, _q.order...),
		inters:        append([]Interceptor{}, _q.inters...),
		predicates:    append([]predicate.UserRoles{}, _q.predicates...),
...
func (_q *UserRolesQuery) GroupBy(field string, fields ...string) *UserRolesGroupBy {
	...
	grbuild := &UserRolesGroupBy{build: _q}
...
func (_q *UserRolesQuery) Select(fields ...string) *UserRolesSelect {
	...
	sbuild := &UserRolesSelect{UserRolesQuery: _q}
...
func (_q *UserRolesQuery) prepareQuery(ctx context.Context) error {
...
func (_q *UserRolesQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserRoles, error) {
	var (
		nodes       = []*UserRoles{}
		_spec       = _q.querySpec()
		loadedTypes = [2]bool{
	...
	_spec.Assign = func(columns []string, values []any) error {
		node := &UserRoles{config: _q.config}
	...
	if query := _q.withLionUsers; query != nil {
		if err := _q.loadLionUsers(ctx, query, nodes, nil,
			func(n *UserRoles, e *Users) { n.Edges.LionUsers = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLionRoles; query != nil {
		if err := _q.loadLionRoles(ctx, query, nodes, nil,
			func(n *UserRoles, e *Roles) { n.Edges.LionRoles = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserRolesQuery) loadLionUsers(ctx context.Context, query *UsersQuery, nodes []*UserRoles, init func(*UserRoles), assign func(*UserRoles, *Users)) error {
...
func (_q *UserRolesQuery) loadLionRoles(ctx context.Context, query *RolesQuery, nodes []*UserRoles, init func(*UserRoles), assign func(*UserRoles, *Roles)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*UserRoles)
	for i := range nodes {
		fk := nodes[i].RoleID
...
func (_q *UserRolesQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *UserRolesQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userroles.Table, userroles.Columns, sqlgraph.NewFieldSpec(userroles.FieldID, field.TypeInt))
	_spec.From = _q.sql
...
func (_q *UserRolesQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *UserRolesGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*UserRolesQuery, *UserRolesGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *UserRolesGroupBy) sqlScan(ctx context.Context, root *UserRolesQuery, v any) error {
...
func (_s *UserRolesSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*UserRolesQuery, *UserRolesSelect](ctx, _s.UserRolesQuery, _s, _s.inters, v)
}

func (_s *UserRolesSelect) sqlScan(ctx context.Context, root *UserRolesQuery, v any) error {
