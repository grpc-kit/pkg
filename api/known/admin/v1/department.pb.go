...
func (x *ListDepartmentUsersRequest) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_known_admin_v1_department_proto_rawDesc = []byte{
	...
	0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x65, 0x70, 0x61, 0x72, 0x74, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x4c, 0x69, 0x73, 0x74, 0x44, 0x65, 0x70, 0x61, 0x72, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x34, 0x5a, 0x32, 0x67,
...
var file_known_admin_v1_department_proto_goTypes = []interface{}{
	...
	(*ListDepartmentUsersRequest)(nil),  // 5: grpc_kit.api.known.admin.v1.ListDepartmentUsersRequest
	(*ListDepartmentUsersResponse)(nil), // 6: grpc_kit.api.known.admin.v1.ListDepartmentUsersResponse
...
func file_known_admin_v1_department_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_known_admin_v1_department_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListDepartmentUsersRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_known_admin_v1_department_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListDepartmentUsersResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
