...
type ListGroupMembersResponse struct {
	...
	// 符合查询条件的用户资源。
	GroupMembers []*UserGroup `protobuf:"bytes,1,rep,name=group_members,json=groupMembers,proto3" json:"group_members,omitempty"`
	// 用于获取下一页结果的 token。
	// - 如果为空，表示没有更多结果。
	// - 客户端不需要理解其内容，只需原样传回。
	// AIP-132: 必须字段。
...
func (x *ListGroupMembersResponse) GetGroupMembers() []*UserGroup {
	if x != nil {
...
var file_known_admin_v1_group_proto_rawDesc = []byte{
	...
	0x22, 0xae, 0x01, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4d, 0x65,
	...
	0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x0c, 0x67, 0x72,
