...
const (
	...
	prefixCredentialCode    = "CREDENTIAL_CODE_"
...
func seedCredentialCode(c adminv1.CredentialCode) string {
	return seedFromEnumName(adminv1.CredentialCode_name, prefixCredentialCode, int32(c))
}
