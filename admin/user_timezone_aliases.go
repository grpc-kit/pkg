...
// Code generated from IANA tzdb 2026b (tzdata.zi Link records). DO NOT EDIT.
// Alias keys are accepted input; values are canonical storage identifiers.
//
//go:generate go run ./internal/gentimezonealiases -source /usr/share/zoneinfo/tzdata.zi -output user_timezone_aliases.go -version 2026b
